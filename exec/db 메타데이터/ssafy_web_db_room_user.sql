...
CREATE TABLE `room_user` (
  `roomuser_no` bigint NOT NULL AUTO_INCREMENT,
  `room_no` bigint DEFAULT NULL,
  `user_no` bigint DEFAULT NULL,
  PRIMARY KEY (`roomuser_no`),
  KEY `FKnwq8x3xstbjfg38jflts6blrj` (`room_no`),
  KEY `FK42hkfmjxtwdcmihekmrkn2s34` (`user_no`),
  CONSTRAINT `FK42hkfmjxtwdcmihekmrkn2s34` FOREIGN KEY (`user_no`) REFERENCES `user` (`user_no`),
  CONSTRAINT `FKnwq8x3xstbjfg38jflts6blrj` FOREIGN KEY (`room_no`) REFERENCES `room` (`room_no`)

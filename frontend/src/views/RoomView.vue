      ...
      this.session.on("signal:score", (event) => {
        ...
        if (this.team1.includes(event.data)) {
          if (
			...
			console.log(this.game.scene.getScene("ropeFightScene").leftTime);
            //console.log(this.personalScore[`${event.data}`]);
            //console.log(this.personalScore);
            if (this.score1 - this.score2 >= 10 || (this.game.scene.getScene("ropeFightScene").leftTime <= 0 && this.score1 > this.score2)) {
          ...
          if (
            ...
            this.score2 += 1;
            this.personalScore[`${event.data}`] += 1;
            if (this.score2 - this.score1 >= 10 || (this.game.scene.getScene("ropeFightScene").leftTime <= 0 && this.score1 < this.score2)) {

<template>
  <ContentBox :height="90" :width="90">
    ...
    >
      <div
        class="room-list d-flex flex-column align-center justify-space-around"
      >
        <RoomItem
      ...
      <div
        class="room-input-footer d-flex align-center flex-row justify-space-between"
      >
        <div class="d-flex flex-row align-center">
          <button class="primary pl-4 pr-4 room-list-btn mr-6" @click="refresh">새로고침</button>
          <PrivateRoomDialog
            class="primary pl-4 pr-4 room-list-btn"
          ></PrivateRoomDialog>
        </div>
        <div class="d-flex flex-row align-center">
          <v-icon
            class="direction-button primary--text"
            size="60px"
            @mouseup="prevPageEvent"
          >
            mdi-chevron-left
          </v-icon>
          <div
            class="primary--text"
            style="font-weight: bold; font-size: 1.7vw"
          >
            {{ curPage }}/{{ lastPage }}
          </div>
          <v-icon
